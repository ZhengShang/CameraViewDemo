...
import static com.zhiyun.android.cameraview.DisplayOrientationDetector.DISPLAY_ORIENTATIONS;
...
public class CaptureRequestFactory {
    ...
    public static CaptureRequest.Builder createPreviewBuilder(CameraDevice cameraDevice,
    ...
    //设置预览-自动聚焦模式
    public static void setPreviewBuilderPreview(CaptureRequest.Builder previewBuilder) throws
    ...
    //设置预览-锁定焦点
    public static void setPreviewBuilderLockfocus(CaptureRequest.Builder previewBuilder) throws
            CameraAccessException {
    ...
    //设置预览-解除锁定焦点
    public static void setPreviewBuilderUnlockfocus(CaptureRequest.Builder previewBuilder) throws
            CameraAccessException {
        previewBuilder.set(CaptureRequest.CONTROL_AF_TRIGGER,
    ...
    //设置预览-聚焦区域
    public static void setPreviewBuilderFocusRegion(CaptureRequest.Builder previewBuilder,
            MeteringRectangle[] meteringRectangleArr) throws
            CameraAccessException {
    ...
    //设置预览-开始手动聚焦
    public static void setPreviewBuilderFocusTrigger(CaptureRequest.Builder previewBuilder) throws
            CameraAccessException {
        previewBuilder.set(CaptureRequest.CONTROL_AF_TRIGGER,
                CameraMetadata.CONTROL_AF_TRIGGER_START);
    ...
    //设置预览-闪光灯模式
    public static CaptureRequest setPreviewBuilderFlash(CaptureRequest.Builder previewBuilder,
            int flashMode) throws
            CameraAccessException {
...
//    //设置预览-Scene模式
//    public static CaptureRequest setPreviewBuilderScene(CaptureRequest.Builder previewBuilder,
//            String scene) throws
//            CameraAccessException {
...
//
//    //设置预览-Effect模式
//    public static CaptureRequest setPreviewBuilderEffect(CaptureRequest.Builder previewBuilder,
//            String effect) throws
//            CameraAccessException {
//        previewBuilder.set(CaptureRequest.CONTROL_EFFECT_MODE,
//                GpuFilterModel.getEffectMode(effect));
//        return previewBuilder.build();
//    }


    //创建拍照请求
    public static CaptureRequest.Builder createCaptureStillBuilder(CameraDevice cameraDevice,
            Surface surface) throws
            CameraAccessException {
    ...
    //设置拍照模式-拍静态图片
    public static void setCaptureBuilderStill(CaptureRequest.Builder captureBuilder,
            WindowManager windowManager) throws
            CameraAccessException {
        captureBuilder.set(CaptureRequest.CONTROL_AF_MODE,
                CaptureRequest.CONTROL_AF_MODE_CONTINUOUS_PICTURE);
//        captureBuilder.set(CaptureRequest.CONTROL_AE_MODE, CaptureRequest
// .CONTROL_AE_MODE_ON_AUTO_FLASH);

        int rotation = windowManager.getDefaultDisplay().getRotation();
        captureBuilder.set(CaptureRequest.JPEG_ORIENTATION, DISPLAY_ORIENTATIONS.get(rotation));
    }

    //设置拍照模式-连续拍摄
    public static void setCaptureBuilderPrecapture(CaptureRequest.Builder captureBuilder) throws
            CameraAccessException {
...
//        captureBuilder.set(CaptureRequest.SENSOR_EXPOSURE_TIME, 10000);
    ...
    //创建录像请求
    public static CaptureRequest.Builder createRecordBuilder(CameraDevice cameraDevice,
            List<Surface> surfaces) throws
            CameraAccessException {
        CaptureRequest.Builder recordBuilder = cameraDevice.createCaptureRequest(
    ...
    //设置预览模式-录像预览
    public static void setPreviewBuilderRecordPreview(CaptureRequest.Builder previewBuilder) throws
            CameraAccessException {
        previewBuilder.set(CaptureRequest.CONTROL_AF_MODE,
